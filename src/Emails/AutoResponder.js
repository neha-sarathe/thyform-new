                            ...
                            <div className={"accordion-item standard p-3 " + (darkmodes ? "text-white dash-chart-dark" : "text-dark bg-white")}>
                                ...
                                >
                                    ...
                                    <Tab eventKey="advanced" title="ADVANCED">
                                            ...
                                            <div className='main_w'>
                                                <div className=' underline d-flex align-items-center py-2 mx-2 '>
                                                    <li className='fs-6 text-black map'>
                                                        <h6 className={'form-setting-title ' + (darkmodes ? "text-white" : "text-dark ")}>PDF Attachment</h6>
                                        ...
                                        <div class="row mainsetting-div">
                                            <div class="form-group col-md-12 mt-3">
                                                <h2 className="form-setting-title">Attach a File</h2>
                                                <p className="form-setting-para"> Users can get this file as email attachment.</p>
                                            </div>
                                        </div>
                                        <div className='text-center border-dotted pt-3 pb-2'>
                                            <button className="notify-btn">
                                                UPLOAD FILE
                                            </button>
                                            <p className="form-setting-para">or drag & drop the file here.
                                            </p>
                                        </div>
                                        ...
                                        <div className='d-flex align-items-center justify-content-between '>
                                            <div className='main_w'>
                                                <div className=' underline d-flex align-items-center py-2 mx-2 '>
                                                    <li className='fs-6 text-black map'>
                                                        <h6 className={'form-setting-title ' + (darkmodes ? "text-white" : "text-dark ")}>Hide Empty Fields</h6>
                                        ...
                                        <div className='d-flex align-items-center justify-content-between '>
                                            <div className='main_w'>
                                                <div className=' underline d-flex align-items-center py-2 mx-2 '>
                                                    <li className='fs-6 text-black map'>
                                                        <h6 className={'form-setting-title ' + (darkmodes ? "text-white" : "text-dark ")}>Update Email</h6>
