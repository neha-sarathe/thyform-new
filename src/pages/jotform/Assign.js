                ...
                {/* <div className="col_6 mt-5"> */}
                  ...
                  <div className='main_w'>
                    <div className=' underline d-flex align-items-center '>
                      <li className='bg-icon-color py-1 px-2 mt-4  text-white fw-bold fs-4 rounded'>
                      ...
                      <li className='fs-6 text-black mt-5 pb-2 map'>
                        ...
                        <p className='paragraph '>Request others to complete your form.</p>
                      </li>
                    </div>
                  </div>
                  {/* direct link div end */}
                  ...
                  <form className={' shadow-sm p-4 rounded-1 '+ (darkmodes ? "text-white dash-chart-dark" : "text-dark bg-white")}>
                    <fieldset>
                      <div className='d-flex align-items-center justify-content-between'>
                        <div className='display-setting display-setting-res '>
                          <li className='link'>
                            <h6 className={'form-setting-title fw-Semibold text-black mt-1 ' + (darkmodes ? "text-white " : "text-dark ")}>ASSIGN WITH LINK</h6>
                          </li>
                          <li>
                        ...
                        <div>
                          <ul className='quick-setting-icon quick-setting-icon-res'>
                            <li>
                            ...
                            <li className='fs-6 fw-semibold setting set-resp'>Settings</li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div className='bg-white py-4 mt-4 rounded-1 border-top'>
                        <div className='d-flex align-items-center justify-content-between '>
                          <li>
                            <h5 className='fw-bold form-setting-title semibold'>ASSIGN TO EVERYONE IN THE ORGANIZATION</h5>
