        ...
        <div className="formpage_item">
          <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item tab-list" role="presentation">
              <button class="nav-link active link-btn-txt" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true"><div><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/svg/2000" class="ji-svg"><g transform="translate(8 3)" fill="#ffffff"><path d="M16.105 24.21a1.105 1.105 0 100-2.21 1.105 1.105 0 000 2.21zM11 6.5a.5.5 0 00-.5.5v18a.5.5 0 00.5.5h9.895a.5.5 0 00.5-.5V7a.5.5 0 00-.5-.5H11zM11 5h9.895a2 2 0 012 2v18a2 2 0 01-2 2H11a2 2 0 01-2-2V7a2 2 0 012-2zm3.553 3h3.315a.553.553 0 110 1.105h-3.315a.553.553 0 010-1.105z"></path></g></svg></div>Phone</button>
            </li>
            <li class="nav-item tab-list" role="presentation">
              <button class="nav-link link-btn-txt" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false"><div><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/svg/2000" class="ji-svg "><g transform="translate(8 3)" fill="#ffffff" ><circle cx="8.5" cy="22.5" r="1.5"></circle><path d="M2 1.5a.5.5 0 00-.5.5v23a.5.5 0 00.5.5h13a.5.5 0 00.5-.5V2a.5.5 0 00-.5-.5H2zM2 0h13a2 2 0 012 2v23a2 2 0 01-2 2H2a2 2 0 01-2-2V2a2 2 0 012-2zM1 1h15v2H1V1z"></path></g></svg></div>Tablet</button>
            </li>
            <li class="nav-item tab-list" role="presentation">
              <button class="nav-link link-btn-txt" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false"><div className='svg-position'><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/svg/2000" class="ji-svg "><g transform="translate(2 6)" fill="#ffffff" fill-rule="evenodd"><rect x="8" y="19" width="13" height="1" rx="0.5"></rect><path d="M11 17h7v3h-7zM1 14h26v2H1z"></path><path d="M1.697 1.214a.415.415 0 00-.424.405v13.762c0 .223.19.405.424.405h24.606a.415.415 0 00.424-.405V1.619a.415.415 0 00-.424-.405H1.697zm0-1.214h24.606C27.24 0 28 .725 28 1.619v13.762c0 .894-.76 1.619-1.697 1.619H1.697C.76 17 0 16.275 0 15.381V1.619C0 .725.76 0 1.697 0z" fill-rule="nonzero"></path></g></svg></div>Desktop</button>
            </li>
          </ul>
          {/* <div
