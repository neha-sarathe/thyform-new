              ...
              <div className={"form-setting-main-div " + (darkmodes ? "text-white dash-chart-dark" : "text-dark bg-white")}>
                <div class="row mainsetting-div">
                  <div class="form-group col-md-12 mt-3 d-flex justify-content-between">
                    <li>
                      ...
                      <p className="form-setting-para">Change the warning messages on your form.</p>
                    </li>
                    <li>
                ...
                <div class="row mainsetting-div">
                  <div class="form-group col-md-12 mt-3">
                    ...
                    <p className="form-setting-para">Please select the language for your form.</p>

                    <div>
                      <select className="form-setting-input" name="cars" id="cars">
                        <option value="volvo">Please select the current language of your form.</option>
                        <option value="saab">Saab</option>
                        <option value="opel">Opel</option>
                        <option value="audi">Audi</option>
                      </select>
                ...
                <div class="row mainsetting-div">
                  <div class="form-group col-md-12 mt-3 d-flex justify-content-between">
                    <li>
                      ...
                      <p className="form-setting-para">Make your form available in multiple languages.</p>
                    </li>
                    <li>
                      <button className="btn btn-primary"> EDIT </button>
                    </li>
                ...
                <div class="row mainsetting-div">
                  <div class="form-group col-md-12 mt-3">
                    ...
                    <p className="form-setting-para">Set a password to limit access to your forms.</p>
                    <label className="float-none d-flex align-items-start mt-4">
                      <input type="checkbox"
                        ...
                        className="mx-3"
                      />
                      <div><h6 className="fw-bold">Enable Password Protection</h6>
                      </div>
                    </label>
                  </div>
                </div>
                <div class="row mainsetting-div">
                  <div class="form-group col-md-12 mt-3">
                    ...
                    <p className="form-setting-para">Encrypt your form responses to store sensitive data securely. </p>
                    <div>
                      <select className="form-setting-input" name="cars" id="cars">
                ...
                <div class="row mainsetting-div">
                  <div class="form-group col-md-12 mt-3 d-flex justify-content-between">
                    <li>
                      <h2 className="form-setting-title">Auto-Delete Form Submissions</h2>
                      <p className="form-setting-para">Delete form submissions after a certain period of time.</p>
                    </li>
                    <li>
                ...
                <div class="row mainsetting-div">
                  <div class="form-group col-md-12 mt-3">
                    ...
                    <p className="form-setting-para">Enable or disable autofill on your form. </p>
                    <div>
                      <select className="form-setting-input" name="cars" id="cars">
                ...
                <div class="row mainsetting-div">
                  <div class="form-group col-md-12 mt-3">
                    ...
                    <p className="form-setting-para">Add Single Sign-On (SSO) login to fill out the form.</p>
                    <label className="float-none d-flex align-items-start mt-4">
                      <input type="checkbox"
                        // defaultChecked={checked}
                        // onChange={handleCheckbox}
                        className="mx-3"
                      />
                      <div><h6 className="fw-bold">Users need to login to view and submit the form</h6>
                      </div>
                    </label>
                    <label className="float-none d-flex align-items-start mt-4">
                      <input type="checkbox"
                        ...
                        className="mx-3"
                      />
                      <div><h6 className="fw-bold">Users can save drafts and continue later</h6>
                      </div>
                    </label>
                  </div>
                </div>
                <div class="row mainsetting-div">
                  <div class="form-group col-md-12 mt-3">
                    ...
                    <p className="form-setting-para">Use cookies (loose check) or IP address (strict check) to prevent multiple form submissions. </p>
                    <div>
                      <select className="form-setting-input" name="cars" id="cars">
                ...
                <div class="row mainsetting-div">
                  <div class="form-group col-md-12 mt-3">
                    ...
                    <p className="form-setting-para">Do not allow previously entered values. </p>
                    <div>
                      <select className="form-setting-input" name="cars" id="cars">
                        <option value="volvo">No Check</option>
                ...
                <div class="row mainsetting-div">
                  <div class="form-group col-md-12 mt-3">
                    ...
                    <p className="form-setting-para">Check your form's accessibility.</p>
                    <div>
                      <select className="form-setting-input" name="cars" id="cars">
                    ...
                    <label className="float-none d-flex align-items-start mt-4">
                      <input type="checkbox"
                        ...
                        className="mx-3"
                      />
                      <div><h6 className="fw-bold">
                        Show the accessibility badge on the form.</h6>
                      </div>
                    </label>
                  </div>
                </div>
                <div class="row mainsetting-div">
                  <div class="form-group col-md-12 mt-3">
                    ...
                    <p className="form-setting-para">Enter the title that will be used as HTML page title.</p>
                    <div>
                      <input className="form-setting-input" />
                    </div>
                  </div>
                ...
                <div class="row mainsetting-div">
                  <div class="form-group col-md-12 mt-3">
                    ...
                    <p className="form-setting-para">Do you want to send HTTP POST data to the Thank-You page?</p>
                    <div>
                      <select className="form-setting-input" name="cars" id="cars">
                        <option value="volvo">No</option>
                        <option value="saab">Yes</option>
                ...
                <div class="row mainsetting-div">
                  <div class="form-group col-md-12 mt-3">
                    <h2 className="form-setting-title">Clear Hidden Field Values</h2>
                    <p className="form-setting-para">Do you want to clear the values of fields hidden by conditional logic?</p>
                    <div>
                      <select className="form-setting-input" name="cars" id="cars">
                ...
                <div class="row mainsetting-div">
                  <div class="form-group col-md-12 mt-3">
                    ...
                    <p className="form-setting-para">Enable or disable the yellow background highlight on input fields.</p>
                    <div>
                      <select className="form-setting-input" name="cars" id="cars">
                        <option value="volvo">Enabled</option>
                        <option value="saab">Disabled</option>
                ...
                <div class="row mainsetting-div">
                  <div class="form-group col-md-12 mt-3">
                    <h2 className="form-setting-title">Show error navigation on forms</h2>
                    <p className="form-setting-para">Navigation between errors on form</p>
                    <div>
                      <select className="form-setting-input" name="cars" id="cars">
                        <option value="volvo">No</option>
                        <option value="saab">Yes</option>
                ...
                <div class="row mainsetting-div">
                  <div class="form-group col-md-12 mt-3">
                    ...
                    <p className="form-setting-para">Prevent other users from cloning this form.</p>
                    <div>
                      <select className="form-setting-input" name="cars" id="cars">
                        <option value="volvo">No</option>
                        <option value="saab">Yes</option>
                ...
                <div class="row mainsetting-div">
                  <div class="form-group col-md-12 mt-3">
                    <h2 className="form-setting-title">Allow Browser AutoComplete</h2>
                    <p className="form-setting-para">Allow browsers to store and autocomplete form fields.</p>
                    <div>
                      <select className="form-setting-input" name="cars" id="cars">
                        <option value="volvo">No</option>
                        <option value="saab">Yes</option>
