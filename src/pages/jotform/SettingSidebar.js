                                        ...
                                        <Link to="/setting/settingform" className="sidebar-link-jot">
                                            <ul className='d-flex '>
                                                ...
                                                <li className='share'>
                                                    ...
                                                    <p className={'font_r fw-7 ' + (darkmodes ? "text-white " : "text-dark ") + (page[2] === 'settingform' ? 'text-dark' : '')}>Form status and properties</p>
                                                </li>
                                            </ul>
                                        </Link>
                                    </div>
                                        ...
                                        <Link to="/setting/settingemail" className="sidebar-link-jot">
                                            <ul className='d-flex '>
                                                ...
                                                <li className='share'>
                                                    ...
                                                    <p className={' fw-7 font_r ' + (darkmodes ? "text-white " : "text-dark ")+ (page[2] === 'settingemail' ?  'text-dark' : '')}>Reminders and  instant sharing.</p>
                                                </li>
                                            </ul>
                                        </Link>
                                    </div>
                                        ...
                                        <Link to="/setting/condition" className="sidebar-link-jot">
                                            <ul className='d-flex '>
                                                ...
                                                <li className='share'>
                                                    ...
                                                    <p className={' fw-7 font_r ' + (darkmodes ? "text-white " : "text-dark ")+ (page[2] === 'condition' ? 'text-dark':'')}>Create conditional logic.</p>
                                                </li>
                                            </ul>
                                        </Link>
                                    </div>
                                    <div className={'quick list-sidebar-jotform py-3 '+ (page[2] === 'thankyoupage' ?  'bg-white' : '')}>
                                        <Link to="/setting/thankyoupage" className="sidebar-link-jot">
                                            <ul className='d-flex '>
                                                ...
                                                <li className='share'>
                                                    <h6 className={' fw-semibold ' + (darkmodes ? "text-white " : "text-dark ")+ (page[2] === 'thankyoupage' ? 'text-dark':'')}>THANK YOU PAGE</h6>
                                                    <p className={' font_r fw-7 ' + (darkmodes ? "text-white " : "text-dark ")+ (page[2] === 'thankyoupage' ? 'text-dark':'')}>Shown after form submit.</p>
                                                </li>
                                            </ul>
                                        </Link>
                                    </div>
                                        ...
                                        <Link to="/setting/mobilenotification" className="sidebar-link-jot">
                                            <ul className='d-flex '>
                                                ...
                                                <li className='share'>
                                                    ...
                                                    <p className={' fw-7 font_r ' + (darkmodes ? "text-white " : "text-dark ")+ (page[2] === 'mobilenotification' ? 'text-dark':'')}>Customize your app notification</p>
                                                </li>
                                            </ul>
                                        </Link>
                                    </div>
