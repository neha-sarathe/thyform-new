                    ...
                    <div className="row">
                      <div className="col-sm-12">
                        <div className="statistics-details d-flex align-items-center justify-content-between">
                          <div>
                            <p className="statistics-title">Total Number of forms</p>
                            <h3 className={"rate-percentage " + (props.darkmodes ? "text-white bg-dark" : "text-dark bg-light")}>32.53%</h3>
                            <p className="text-danger d-flex"><i className="mdi mdi-menu-down"></i><span>-0.5%</span></p>
                          </div>
                          <div>
                            <p className="statistics-title">Form Views</p>
                            <h3 className={"rate-percentage " + (props.darkmodes ? "text-white bg-dark" : "text-dark bg-light")}>7,682</h3>
                            <p className="text-success d-flex"><i className="mdi mdi-menu-up"></i><span>+0.1%</span></p>
                          </div>
                          <div>
                            <p className="statistics-title">New Forms</p>
                            <h3 className={"rate-percentage " + (props.darkmodes ? "text-white bg-dark" : "text-dark bg-light")}>68.8</h3>
                            <p className="text-danger d-flex"><i className="mdi mdi-menu-down"></i><span>68.8</span></p>
                          </div>
                          <div className="d-none d-md-block">
                            <p className="statistics-title">Avg. Time on Form</p>
                            <h3 className={"rate-percentage " + (props.darkmodes ? "text-white bg-dark" : "text-dark bg-light")}>2m:35s</h3>
