                        ...
                        <div className={" row flex-grow form-bg1 drag-sort-enable " + (props.darkmodes ? "text-white bg-dark" : "text-dark bg-white")}>
                            ...
                            <div className="col-lg-6 d-flex align-items-center justify-content-center">
                                <div className="auth-form-transparent text-left p-3">
                                    ...
                                    <div>
                                        <h4 className="heading-form dark-mode-text">User SignUp Form</h4>
                                        <ToggleSwitch values={['weeks', 'months', 'years']} selected="days" />
                                        ...
                                        <div className="mt-3 text-end d-flex align-items-center justify-content-between">
                                            ...
                                            <button className={"btn  auth-form-btn auth-form-btn1 " + (props.darkmodes ? "hover-text-white" : "hover-text-white")} onClick={nextPage}>Submit <FiChevronRight /></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
