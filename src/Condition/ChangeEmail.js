                ...
                <div className="container ">
                    ...
                    <div className="col-sm-2 col-md-8 col-lg-8 col-xl-8 condition_margin_adjust condition_margin_mob">
                            ...
                            <div className='main_w'>
                                ...
                                <li className='shown px-2 rounded-1 calculater email-icon-color pb-2 mt-4'>
                                        <FaEnvelope />
                                    </li>

                                    <li className='fs-6 text-black mt-5 pb-2 map'>
                                        <h5 className={'heading_5 remider fw-bold .showhover ' + (darkmodes ? "text-white" : "text-dark ")}>CHANGE E-MAIL RECIPIENT</h5>
                                        <p className={'paragraph ' + (darkmodes ? "text-white" : "text-dark ")}>Redirect your e-mail alerts according to the form entry.</p>
                                    </li>
                                </div>
                            </div>
